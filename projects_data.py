# projects_data.py
# Pangaea Advisory — Project Master Dataset
...
PROJECTS = {
    ...
    "the_lisboans": {
        ...
        "determinant_scores": {
            ...
            "litigation_history": 7.0,   # INVERSE — higher = cleaner record
    ...
    "ellinikon": {
        ...
        # Sourced directly from Excel — Lamda Development (Riviera Tower profile)
        "determinant_scores": {
            "project_exit_liquidity": 4.0,
            "expected_rental_yield": 5.0,
            "public_infrastructure_proximity": 5.0,
    ...
    "greencrest": {
        ...
        # Sourced from Excel — Emaar (Avarra by Palace profile)
        "determinant_scores": {
            "project_exit_liquidity": 4.0,
    ...
    "sobha_hartland": {
        ...
        # Sourced directly from Excel — Sobha Hartland II profile
        "determinant_scores": {
    ...
    "burj_binghatti": {
        ...
        # Sourced directly from Excel — Binghatti Bugatti Residences profile
        "determinant_scores": {
            "project_exit_liquidity": 3.0,
    ...
    "damac_islands": {
        ...
        # Sourced directly from Excel — Damac Elegance Tower profile
        "determinant_scores": {
            "project_exit_liquidity": 4.0,
            "expected_rental_yield": 6.0,
            "public_infrastructure_proximity": 5.0,
